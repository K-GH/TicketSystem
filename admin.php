...
<div  align="right">
  ...
  <a href="Logout.php" class="btn btn-info btn-lg" >
       <span class="glyphicon glyphicon-log-out" ></span> Log out
                ...
                <h1 align="center" >Welcome  <?php echo $admin_name; ?>  </h1>
                <h1> </h1>


   <br />

   <h1 align="center"> Customers Orders</h1>
   <br />
   ...
   <h1 align="center">Reply Employee / Customers</h1>
   <br />



     <div class="table-responsive">
    <table id="replay_data" class="table table-bordered table-striped">
     <thead>
         <tr>
             <th data-column-id="Project_id">Project ID  </th>
             <th data-column-id="total_time">Total Time </th>
             <th data-column-id="price" > Price </th>
             <th data-column-id="emp_id"> Employee ID Reply </th>
             <th data-column-id="appro_reg"> User Approve / Reject </th>
             <th data-column-id="date"> reply Date </th>
...
<script src="assets/js/scripts.js"></script>
            ...
            <script type="text/javascript" language="javascript" >
                ...
                var OrderTable = $('#replay_data').bootgrid({
                    ajax: true,
                    rowSelect: true,
                    post: function()
                    {
